...
def result():
    ...
    # load data
    vectors = pd.read_json("/home/user_4/CBF/Token/final_tokens_2.json")
    ...
    with open('/home/user_1/medistream-recsys/application2/static/data/des_tokenized.pkl','rb') as f:
    ...
    num_topics = 35
    lda_model_final = models.LdaModel.load('/home/user_1/medistream-recsys/Script/YS/CBF'+'/models6/ldamodels_bow_'+str(num_topics)+'.lda')
